...
import { updateStateAction, deleteOffer } from "../../Store/Actions/updateState";
...
export default function OffersCard(props) {
  ...
  const updateOfferStatusAccepted = (offer) => {
    ...
    window.alert("Accepted this offer successfully!");

  };
  const updateOfferStatusRejected = (offer) => {
    dispatch(deleteOffer(offer));
    window.alert("Rejected this offer!");
  };
  return (
                      ...
                      <Grid item xs={12}>
                        <Item>
                          <IconButton>
                            <Chip
                              icon={
                                <AttachMoneyIcon style={{ fill: "#151A1E" }} />
                              }
                              label={offer.price}
                              variant="outlined"
                              sx={{
