...
export default function Register() {
    ...
    const submitForm = (e) => {
        ...
        if (!errors.emailErr && !errors.passwordErr) {
            // SEND API REQUEST
            axios
            .post("http://127.0.0.1:8000/base/users/")
            .then((res) => setUserForm(res.data))
            .catch((err) => console.log(err));
                    ...
                    <div className="col-8 mainPage">
                        ...
                        <form onSubmit={(e) => submitForm(e)} className="col-8">
                            ...
                            <div className="mb-2 mr-5">
                                ...
                                {/* <button onClick={togglePassword} className="btn btn-default">
                                    Show Password
                                </button> */}
                            </div>
                            {/* ----------------------------------------------------------------------------------------- */}
                            <div className="mb-2 mr-5">
                                ...
                                <input
                                    type="password"
                                    className={`form-control ${errors.confirmpassErr ? "border-danger" : ""
                                        }`}
                                    id="conpasswordID"
                            ...
                            {/* <div className="text-danger">{errors.loginError}</div> */}
                            <div className="row">
                            <button
