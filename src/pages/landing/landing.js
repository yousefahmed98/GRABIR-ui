    ...
    return (
        <div id="page-top">
            ...
            <header className="masthead">
                <div className="container">
                    <div className="masthead-subheading">Welcome To Our Delivering Platform!</div>
                    ...
                    <a className="btn btn-primary btn-xl text-uppercase" style={{marginRight:20}} href="/login">
                        Login
                    </a>
                    
                    <a className="btn btn-primary btn-xl text-uppercase" href="/register">
                        Register
                    </a>
                </div>
            </header>
